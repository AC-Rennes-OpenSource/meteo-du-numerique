...
import '../../../../domain/blocs/search/search_event.dart';
import '../../../../domain/blocs/search/search_state.dart';
...
class _CustomSearchBarState extends State<CustomSearchBar> {
  ...
  void _onTabChange() {
    if (_tabController.indexIsChanging) {
      if (context.read<SearchBloc>().state is ClearedAll) {
        searchQueries[0] = '';
        searchQueries[1] = '';
  ...
  void _updateSearchBar(int tabIndex) {
    ...
    if (currentQuery != null && currentQuery.isNotEmpty) {
      context.read<SearchBloc>().add(OpenSearchBar());
      _searchController.text = currentQuery;
      _focusNode.requestFocus();
    } else {
      context.read<SearchBloc>().add(CloseSearchBar());
      _searchController.clear();
      _focusNode.unfocus();
    }
  }
            ...
            child: AnimatedContainer(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    icon: Icon(state is SearchOpened || _searchController.text.isNotEmpty ? 
