...
import 'package:meteo_du_numerique/data/services/notification_service.dart';
...
class _AppState extends State<App> {
  ...
  void initState() {
    ...
    _serviceLocator<NotificationService>().onNotificationTap.listen(_handleNotificationTap);
  }

  Future<void> _initializeApp() async {
    try {
      // Remote config is already initialized in main.dart
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => _serviceLocator<ThemeCubit>()),
        BlocProvider(create: (_) => _serviceLocator<SearchCubit>()),
